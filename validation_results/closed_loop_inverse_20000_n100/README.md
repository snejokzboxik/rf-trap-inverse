...
| Metric | Value |
|---|---:|
| Mean closed-loop minimum error | 96.296420 µm |
| Median closed-loop minimum error | 79.384966 µm |
| 95th-percentile error | 212.087844 µm |
| Maximum error | 403.643453 µm |
| Exactly-three robust topology | 100 / 100 |
| Included clean rows | 100 / 100 |
| Solver failures | 0 |
| Ambiguous/rejected rows | 0 |
| Rows with robust-rejected extra candidates | 7 |
...
The MLP produced **3** coordinates outside the generator's ±500 µm training range. The largest absolute predicted coordinate was **513.727844 µm**. These values were not clipped before FEM evaluation.
