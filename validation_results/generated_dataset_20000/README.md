...
This directory contains 20000 deterministic forward samples drawn
with NumPy's `default_rng` seed `20260723`. Each raw displacement
...
Counts: clean `20000`, rejected
`0`, ambiguous branch
`0`. Status counts: `{'clean': 20000}`.
