...
This directory contains 5000 deterministic forward samples drawn
with NumPy's `default_rng` seed `20260721`. Each raw displacement
...
Counts: clean `5000`, rejected
`0`, ambiguous branch
`0`. Status counts: `{'clean': 5000}`.
