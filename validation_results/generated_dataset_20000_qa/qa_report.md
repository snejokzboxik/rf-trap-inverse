...
Clean rows: **20000**; rejected rows: **0**; completely parsed clean rows: **20000**.
...
Minimum electrode-surface clearance: **6.77952 mm**; minimum outer-boundary clearance: **43.6261 mm**.
Largest absolute minimum coordinate: **6.37375 mm** versus the 8 mm search half-width.
...
|---|---:|---:|---:|---:|---:|
| Wolfram displacement coordinates (µm) | -499.993769 | 499.997626 | 0.191957608 | 289.215587 | 0.496823212 |
| Minimum x coordinates (mm) | -6.28143643 | 6.35308244 | -0.000196181756 | 2.67891022 | 0.00170528703 |
| Minimum y coordinates (mm) | -6.32026098 | 6.37375096 | -0.00234840232 | 2.68417962 | -0.0205402973 |
| Minimum pairwise distance (mm) | 0.597306575 | 9.13235433 | 5.26942221 | 1.40826047 | 5.35558784 |
...
- Aggregate Wolfram displacement standard deviation is 289.216 µm versus 288.675 µm for an ideal continuous uniform distribution.
- Aggregate minimum-coordinate mean is (-0.000196182, -0.0023484) mm; small nonzero finite-sample offsets are not a schema defect.
- The closest minimum pair is 0.597307 mm, 3.982 times the 0.15 mm rejection threshold.
- 9 rows are below 1 mm and 274 are below 2 mm. The closest is sample 19352 with 12 additional robust-rejected candidates; it remains clean under the documented threshold.
- 1493 clean rows contain at least one candidate rejected by robust quality rules; this is compatible with exactly three robust-accepted minima.
